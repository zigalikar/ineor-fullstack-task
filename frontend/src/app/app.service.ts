...
export class AppService {
  ...
  public get(id: string): Observable<Beach | undefined> {
    return this.http.get<Beach>(`${this.baseUrl}/beaches/${id}`).pipe(catchError(() => of(undefined)));
  }

  public create(data: Beach): Observable<Beach | undefined> {
    return this.http.post<Beach>(`${this.baseUrl}/beaches`, data).pipe(catchError(() => of(undefined)));
  }

  public edit(id: string, data: Beach): Observable<Beach | undefined> {
    return this.http.put<Beach>(`${this.baseUrl}/beaches/${id}`, data).pipe(catchError(() => of(undefined)));
  }

  public delete(id: string): Observable<Beach | undefined> {
    return this.http.delete<Beach>(`${this.baseUrl}/beaches/${id}`).pipe(catchError(() => of(undefined)));
  }
}
